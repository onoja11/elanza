...
const Footer = () => {
  return (
    <footer className="bg-[#2E2B26] text-[#F8F5EF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-[#B89B5E] hover:text-[#A47E3C] transition-colors">
          ...
          <div>
            <h4 className="font-semibold text-[#F8F5EF] mb-4">Quick Links</h4>
            <ul className="space-y-2">
              {["Shop Fashion", "Book Services", "Fabric Store", "Become a Seller", "Join as Professional"].map((link, i) => (
                <li key={i}>
                  <a href="#" className="text-[#6B675E] hover:text-[#B89B5E] transition-colors">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            <h4 className="font-semibold text-[#F8F5EF] mb-4">Support</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-[#4B2E2B] mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-[#6B675E] text-sm">© 2024 Elanza. All rights reserved.</p>
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            {[
              ...
              <a key={i} href={link.href} className="text-[#6B675E] hover:text-[#B89B5E] text-sm transition-colors">
                {link.text}
              </a>
            ))}
          </div>
